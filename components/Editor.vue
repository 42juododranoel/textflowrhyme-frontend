    ...
    <div class="editor">
      ...
      <div class="pt-5">
        <div class="btn-group" role="group" aria-label="Configure editing modes">
          <input
            ...
            class="btn-check"
            name="btncheckbox"
            id="button-mode-length"
            autocomplete="off"
            :checked="is_length_checked"
            @click="switch_length"
          />
          <label class="btn btn-outline-primary" for="button-mode-length"
            ><i class="bi bi-body-text me-1"></i>Length</label
          >
          ...
          <input
            ...
            class="btn-check"
            name="btncheckbox"
            id="button-mode-fatigue"
            autocomplete="off"
            :checked="is_fatigue_checked"
            @click="switch_fatigue"
          />
          <label class="btn btn-outline-primary" for="button-mode-fatigue"
            ><i class="bi bi-book me-1"></i>Fatigue</label
          >
        </div>
      </div>
      ...
      <div class="pt-5">
        <button
          ...
          :disabled="rewrite_togetherai_api_key ? false : true"
          @click="rewrite"
        >
          <i class="bi bi-play me-1"></i>Rewrite
        </button>
        <button
          type="button"
          class="btn btn-outline-secondary"
          data-bs-toggle="modal"
          data-bs-target="#text-rewrite-settings"
        >
        ...
        <div
          class="modal fade"
          id="text-rewrite-settings"
          tabindex="-1"
          aria-labelledby="text-rewrite-settings-label"
          aria-hidden="true"
        >
                ...
                <div class="container-fluid">
                  <div class="row">
                    <div class="col">
                      ...
                      <div class="mb-3">
                        <label for="togetherai-apikey" class="form-label"
                          >Together.ai API Key</label
                        >
                        <input
                          type="text"
                          class="form-control"
                          id="togetherai-apikey"
                          aria-describedby="togetherai-apikey-help"
      ...
      <div>
        <p class="editor--correction" contenteditable="true" :class="{ 'd-none': !correction }">
          {{ correction }}
        </p>
...
const editor = useEditor({
  ...
  extensions: [LengthMark, FatigueMark, EditorDocument, EditorParagraph, EditorText, History],
  onCreate: () => {
    analyze()
  },
  onUpdate: () => {
